    ...
    <div class="col-12  m-t-3">
        ...
        <div class="table-responsive">
            <div style="width: 100%; display:block">
                <a onclick="generateExcel();" target="_blank" style="float:right;color:#fff" class="btn btn-success"><i class="ti-plus"></i>&nbsp; Nuevo</a>
            </div>
            <table id="tbl_parques" class="table table-bordered table-hover" data-name="cool-table">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Nombre</th>
...
<script>
    ...
    function floadParques(){
        $('.desactivarC').fadeIn(500);
        $('#tbl_parques').dataTable({
            ajax : {
                "url":  "<?php url('Lopersa/loadParques'); ?>",
                "data":function (d){
                    d.nombre = $("#bNombre").val();
            ...
            "columns": [ //agregar configuraciones a cada una de las columnas de las tablas
                ...
                { "class": "text-center", "orderable": false },//column 3
                { "class": "text-center", "orderable": false },//column 4
            ...
            $.ajax({
                ...
                success : function (json){
                    if(json.success == true){
                        ...
                        fVolta();
                        $('#tbl_parques').DataTable().ajax.reload(function(){
                            $('.desactivarC').fadeOut(500);
                            markers.forEach(function(marker) {
                                marker.setMap(null);
                            });
