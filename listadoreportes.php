            ...
            <div class="row">
                <div class="col-lg-3">
                    <fieldset class="form-group">
                        <label>Tipo:</label>
                        <select id="bTipo" name="bTipo" class="form-control">
                            <option value="">Todos</option>
                            <option value="parques">Parques</option>
                            <option value="zonasverdes">Zonas verdes</option>
...
<div class="content mt-3 md p-20 listCasos">
    <div class="col-12  m-t-3">
        ...
        <div class="table-responsive">
            <table id="tbl_reportes" class="table table-bordered table-hover" data-name="cool-table">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Parque</th>
...
<script>
    ...
    function floadReportes(){
        $('.desactivarC').fadeIn(500);
        $('#tbl_reportes').dataTable({
            ajax : {
                "url":  "<?php url('Lopersa/loadReportes'); ?>",
                "data":function (d){
                    d.tipo = $("#bTipo").val();
            ...
            $.ajax({
                ...
                success : function (json){
                    if(json.success == true){
                        ...
                        fVolta();
                        $('#tbl_reportes').DataTable().ajax.reload(function(){
                            $('.desactivarC').fadeOut(500);
                            markers.forEach(function(marker) {
                                marker.setMap(null);
                            });
